...
//create a predefined username and pass since we do not have database
$acc_username = "Admin";
$acc_password = "AdminAccount";
$acc_fullname = "Admin";
...
//GET THE USERNAME AND PASS FROM THE FORM AND COMPARE TO THE PREDEFINED USERNAME AND PASS
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">YourStyle login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			}else if(isset($_REQUEST['logfirt'])===true){
